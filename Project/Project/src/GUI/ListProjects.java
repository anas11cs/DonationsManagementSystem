...
public class ListProjects extends javax.swing.JFrame {
    ...
    public ListProjects() {
     ...
     public ListProjects(Organization o1) {
        initComponents();
        BLL b=BLL.getInstance();
        o=o1;
       plist= b.getProjOrganization(o1);
          for(int i=0;i<plist.size();i++)
            listModel.addElement(plist.get(i).projName);
    ...
    private void initComponents() {
        ...
        jButton4.setForeground(new java.awt.Color(150, 75, 0));
...
// TODO add your handling code here:
 ...
 if(plist.size()>0){
      Project2 p=new Project2( o, plist.get(jList2.getSelectedIndex()));
